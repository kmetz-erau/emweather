      ...
      <header className="border-b border-[#21262d] bg-[#0d1117] sticky top-0 z-10">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="/" className="px-3 py-1.5 text-xs font-mono border border-[#30363d] rounded text-slate-400 hover:text-slate-200">Daytona Beach</a>
            <a href="/prescott" className="px-3 py-1.5 text-xs font-mono border border-emerald-800 rounded text-emerald-300 hover:bg-emerald-950/30">Prescott</a>
